        ...
        userFilesDropzone: {
            ...
            initFileUploader: function (base, target) {
                ...
                var onyxDropzone = new Dropzone(target, {
                    ...
                    url: objectParam.Url, // Check that our form has an action attr and if not, set one here
                    maxFiles: objectParam.MaxFile,
                    maxFilesize: objectParam.MaxFileSize,
                    acceptedFiles: objectParam.AcceptedFiles,
